...
public class AdjListGraph<V, E> implements Graph<V, E> {
    ...
    */
    ...
    @SpaceComplexity("o(1)")
    private class InnerEdge<E> extends HashMap<Object,Object> implements Edge<E> {
        private E element;
    ...
    @SpaceComplexity("o(n)")
    private class InnerVertex<V> extends HashMap<Object,Object> implements Vertex<V> {
